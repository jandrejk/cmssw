...
calibratedPatElectrons94Xv2 = RecoEgamma.EgammaTools.calibratedEgammas_cff.calibratedPatElectrons.clone(
    produceCalibratedObjs = False
)
...
slimmedElectronsWithUserData = cms.EDProducer("PATElectronUserDataEmbedder",
    src = cms.InputTag("slimmedElectrons"),
    userFloats = cms.PSet(
        mvaFall17Iso = cms.InputTag("electronMVAValueMapProducer:ElectronMVAEstimatorRun2Fall17IsoV1Values"),
        mvaFall17noIso = cms.InputTag("electronMVAValueMapProducer:ElectronMVAEstimatorRun2Fall17NoIsoV1Values"),
        mvaFall17Iso_v2 = cms.InputTag("electronMVAValueMapProducer:ElectronMVAEstimatorRun2Fall17IsoV2Values"),
        mvaFall17noIso_v2 = cms.InputTag("electronMVAValueMapProducer:ElectronMVAEstimatorRun2Fall17NoIsoV2Values"),        
    ...
    userIntFromBools = cms.PSet(
        ...
        mvaFall17Iso_WP80 = cms.InputTag("egmGsfElectronIDs:mvaEleID-Fall17-iso-V1-wp80"),
        mvaFall17Iso_WPL = cms.InputTag("egmGsfElectronIDs:mvaEleID-Fall17-iso-V1-wpLoose"),
        ...
        mvaFall17Iso_WP90_v2 =cms.InputTag("egmGsfElectronIDs:mvaEleID-Fall17-noIso-V2-wp90"),
        mvaFall17Iso_WP80_v2 =cms.InputTag("egmGsfElectronIDs:mvaEleID-Fall17-noIso-V2-wp80"),
        mvaFall17Iso_WPL_v2 =cms.InputTag("egmGsfElectronIDs:mvaEleID-Fall17-noIso-V2-wpLoose"),
        mvaFall17noIso_WP90_v2 =cms.InputTag("egmGsfElectronIDs:mvaEleID-Fall17-iso-V2-wp90"),
        mvaFall17noIso_WP80_v2 =cms.InputTag("egmGsfElectronIDs:mvaEleID-Fall17-iso-V2-wp80"),
        mvaFall17noIso_WPL_v2 =cms.InputTag("egmGsfElectronIDs:mvaEleID-Fall17-iso-V2-wpLoose"),
        ...
        cutbasedID_veto_v2 = cms.InputTag("egmGsfElectronIDs:cutBasedElectronID-Fall17-94X-V2-veto"),
        cutbasedID_loose_v2 = cms.InputTag("egmGsfElectronIDs:cutBasedElectronID-Fall17-94X-V2-loose"),
        cutbasedID_medium_v2 = cms.InputTag("egmGsfElectronIDs:cutBasedElectronID-Fall17-94X-V2-medium"),
        cutbasedID_tight_v2 = cms.InputTag("egmGsfElectronIDs:cutBasedElectronID-Fall17-94X-V2-tight"),
...
#     ecalTrkEnergyErrPreCorr  = cms.InputTag("calibratedPatElectrons94Xv2","ecalTrkEnergyErrPreCorr"),
#     ecalTrkEnergyErrPostCorr = cms.InputTag("calibratedPatElectrons94Xv2","ecalTrkEnergyErrPostCorr"),
#     ecalTrkEnergyPreCorr     = cms.InputTag("calibratedPatElectrons94Xv2","ecalTrkEnergyPreCorr"),
#     ecalTrkEnergyPostCorr    = cms.InputTag("calibratedPatElectrons94Xv2","ecalTrkEnergyPostCorr"),
#     # ecalTrkEnergyPreCorr = cms.InputTag("electronCorrection:ecalTrkEnergyPreCorr"),
#     # ecalTrkEnergyPostCorr = cms.InputTag("electronCorrection:ecalTrkEnergyPostCorr"),
#     # ecalTrkEnergyErrPreCorr = cms.InputTag("electronCorrection:ecalTrkEnergyErrPreCorr"),
#     # ecalTrkEnergyErrPostCorr = cms.InputTag("electronCorrection:ecalTrkEnergyErrPostCorr"),
...
electronMVATTH= cms.EDProducer("EleBaseMVAValueMapProducer",
    ...
    variables = cms.PSet(
        ...
        LepGood_mvaIdFall17noIso = cms.string("userFloat('mvaFall17noIso')"),
    )
)
...
electronTable = cms.EDProducer("SimpleCandidateFlatTableProducer",
    ...
    variables = cms.PSet(CandVars,
        ...
        mvaFall17Iso = Var("userFloat('mvaFall17Iso')",float,doc="MVA Iso ID score"),
        mvaFall17Iso_WP80 = Var("userInt('mvaFall17Iso_WP80')",bool,doc="MVA Iso ID WP80"),
        mvaFall17Iso_WP90 = Var("userInt('mvaFall17Iso_WP90')",bool,doc="MVA Iso ID WP90"),
        mvaFall17Iso_WPL = Var("userInt('mvaFall17Iso_WPL')",bool,doc="MVA Iso ID loose WP"),
        mvaFall17noIso = Var("userFloat('mvaFall17noIso')",float,doc="MVA noIso ID score"),
        mvaFall17noIso_WP80 = Var("userInt('mvaFall17noIso_WP80')",bool,doc="MVA noIso ID WP80"),
        ...
        mvaFall17Iso_v2 = Var("userFloat('mvaFall17Iso_v2')",float,doc="MVA Iso ID score"),
        mvaFall17Iso_WP80_v2 = Var("userInt('mvaFall17Iso_WP80_v2')",bool,doc="MVA Iso ID WP80"),
        mvaFall17Iso_WP90_v2 = Var("userInt('mvaFall17Iso_WP90_v2')",bool,doc="MVA Iso ID WP90"),
        mvaFall17Iso_WPL_v2 = Var("userInt('mvaFall17Iso_WPL_v2')",bool,doc="MVA Iso ID loose WP"),
        mvaFall17noIso_v2 = Var("userFloat('mvaFall17noIso_v2')",float,doc="MVA noIso ID score"),
        mvaFall17noIso_WP80_v2 = Var("userInt('mvaFall17noIso_WP80_v2')",bool,doc="MVA noIso ID WP80"),
        mvaFall17noIso_WP90_v2 = Var("userInt('mvaFall17noIso_WP90_v2')",bool,doc="MVA noIso ID WP90"),
        mvaFall17noIso_WPL_v2 = Var("userInt('mvaFall17noIso_WPL_v2')",bool,doc="MVA noIso ID loose WP"),
        ...
        cutBased_v2 = Var("userInt('cutbasedID_veto_v2')+userInt('cutbasedID_loose_v2')+userInt('cutbasedID_medium_v2')+userInt('cutbasedID_tight_v2')",int,doc="cut-based ID (0:fail, 1:veto, 2:loose, 3:medium, 4:tight)"),
...
run2_nanoAOD_94X2016.toModify(electronTable.variables,
    ...
    cutBased17 = Var("electronID('cutBasedElectronID-Fall17-94X-V1-veto')+electronID('cutBasedElectronID-Fall17-94X-V1-loose')+electronID('cutBasedElectronID-Fall17-94X-V1-medium')+electronID('cutBasedElectronID-Fall17-94X-V1-tight')",int,doc="cut-based Fall17 ID (0:fail, 1:veto, 2:loose, 3:medium, 4:tight)"),
    ...
    mvaFall17Iso = Var("userFloat('ElectronMVAEstimatorRun2Fall17IsoV1Values')",float,doc="MVA Fall17 V1 Iso ID score"),
    mvaFall17Iso_WP80 = Var("electronID('mvaEleID-Fall17-iso-V1-wp80')",bool,doc="MVA Fall17 V1 Iso ID WP80"),
    mvaFall17Iso_WP90 = Var("electronID('mvaEleID-Fall17-iso-V1-wp90')",bool,doc="MVA Fall17 V1 Iso ID WP90"),
    mvaFall17Iso_WPL = Var("electronID('mvaEleID-Fall17-iso-V1-wpLoose')",bool,doc="MVA Fall17 V1 Iso ID loose WP"),
    mvaFall17noIso = Var("userFloat('ElectronMVAEstimatorRun2Fall17NoIsoV1Values')",float,doc="MVA Fall17 V1 noIso ID score"),
    mvaFall17noIso_WP80 = Var("electronID('mvaEleID-Fall17-noIso-V1-wp80')",bool,doc="MVA Fall17 V1 noIso ID WP80"),
    mvaFall17noIso_WP90 = Var("electronID('mvaEleID-Fall17-noIso-V1-wp90')",bool,doc="MVA Fall17 V1 noIso ID WP90"),
    mvaFall17noIso_WPL = Var("electronID('mvaEleID-Fall17-noIso-V1-wpLoose')",bool,doc="MVA Fall17 V1 noIso ID loose WP"),
)
run2_miniAOD_80XLegacy.toModify(electronTable.variables,
    ...
    mvaFall17Iso = None,
    mvaFall17Iso_WP80 = None,
    mvaFall17Iso_WP90 = None,
    mvaFall17Iso_WPL = None,
    mvaFall17noIso = None,
...
_with94Xv1Scale_sequence_v1 = electronSequence.copy()
_with94Xv1Scale_sequence_v1.replace(slimmedElectronsWithUserData, calibratedPatElectrons94Xv1 + slimmedElectronsWithUserData)
run2_nanoAOD_94XMiniAODv1.toReplaceWith(electronSequence, _with94Xv1Scale_sequence_v1)

# _with94Xv1Scale_sequence_v2 = electronSequence.copy()
# _with94Xv1Scale_sequence_v2.replace(slimmedElectronsWithUserData, calibratedPatElectrons94Xv2 + slimmedElectronsWithUserData)
# run2_nanoAOD_94XMiniAODv2.toReplaceWith(electronSequence, _with94Xv1Scale_sequence_v2)
